...
import { gitRoot } from "../../../src/core/services/mcp-paths.js";
...
test("gitRoot returns null when git root is unavailable", () => {
  const host = new FakeHost({
    home: "/home/local",
    env: {},
  ...
  expect(gitRoot(host, "/home/local/work/src/index.ts")).toBeNull();
});
